...
source(".\\Niche filling\\F_Create_Package_BIOMOD.r")
...
# Reference raster for coordinate system
ref.raster <- raster("Y://GIS map and Climate data//lcdbv41landcoverdata1km.bil")
...
try(lapply(spname, runBiomod, data = climate.occ3, myExpl = myExpl, folder.name = "18Oct18"),
    silent = FALSE)
...
lapply(folders, projectionPlot, proj.name = "18Oct18")
...
lapply(folders, ensembleModelling_projection, 
       folder.name = "18Oct18", BIOMODproj.name = "18Oct18", ensambleProj.name = "18Oct18_ensamble")
...
lapply(folders, EMprojectionPlot, proj.name = "18Oct18_ensamble")
